...
def main():
    ...
    print(f"{get_prepositional_phrase(1)} {get_verb(1, 'past')}")
    print(f"{get_prepositional_phrase(2)} {get_verb(2, 'past')}")
    print(f"{get_prepositional_phrase(1)} {get_verb(1, 'present')}")
    print(f"{get_prepositional_phrase(2)} {get_verb(2, 'present')}")
    print(f"{get_prepositional_phrase(1)} {get_verb(1, 'future')}")
    print(f"{get_prepositional_phrase(2)} {get_verb(2, 'future')}")
